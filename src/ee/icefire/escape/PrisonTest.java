...
public class PrisonTest {
    ...
    private static final String MY_FIRST_NAME = "Christer";
    private static final String MY_LAST_NAME = "Lohk";
    ...
    public void parserShouldReadMyName() {
        ...
        Assert.assertEquals(MY_FIRST_NAME, person.getFirstName());
        Assert.assertEquals(MY_LAST_NAME, person.getLastName());
    }
